...
{
	//- Exp time
	valid_ranges.min_exp_time = MIN_TIME_NOT_DEFINED;
	valid_ranges.max_exp_time = MAX_TIME_NOT_DEFINED;

	valid_ranges.min_lat_time = MIN_TIME_NOT_DEFINED;
	valid_ranges.max_lat_time = MAX_TIME_NOT_DEFINED;
}
